...
object IpsScheme : CredentialScheme {

    override val schemaUri: String = "ips.json"//ToDo: ips.json bedeutet noch nichts!!! //"https://wallet.a-sit.at/schemas/1.0.0/healthid.json" //Todo: Was mache ich hiermit? -> Das ist die spätere Darstellung des Credentials?
    override val sdJwtType: String = "urn:eu.europa.ec.eudi:ips:1" //Entspricht VCT -> WICHTIG: Issuer muss genau das als VCT zurück schicken!
    //override val isoDocType: String = "eu.europa.ec.eudi.ips.1" //Braucht es für ISO mdoc nicht für SD-JWT
    //override val isoNamespace: String = "eu.europa.ec.eudi.ips.1" //Braucht es für ISO mdoc nicht für SD-JWT
    override val supportedRepresentations: Collection<CredentialRepresentation> =
        listOf(SD_JWT /*, ISO_MDOC*/)

    //WICHTIG: Alles darunter gehört noch zur Health ID!!! -> Muss für IPS angepasst werden!
